...
class FrontendController extends Controller
{
    public function getSectionTitle(): Collection
    {
        $keys = [
            ...
            'chef_team_top_title', 'chef_team_main_title', 'chef_team_sub_title',
            'testimonial_top_title', 'testimonial_main_title', 'testimonial_sub_title'
        ];
    ...
    public function applyCoupon(Request $request)
    {
        ...
        return response([
            ...
            'finalTotal' => $finalTotal, 'discount' => $discount,
            'coupon_code' => $code
        ]);
    }
