        ...
        <div class="card-body border">
            <form action="{{ route('admin.razorpay-settings.update') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input name="razorpay_currency_rate" value="{{ @$paymentGateway['razorpay_currency_rate'] }}" type="text"
                        class="form-control">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input name="razorpay_secret_key" value="{{ @$paymentGateway['razorpay_secret_key'] }}" type="text"
                        class="form-control">
                </div>
